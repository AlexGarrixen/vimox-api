...
import { SENDGRID_API_KEY, SENGRID_CLIENT } from './env';

sgMail.setApiKey(SENDGRID_API_KEY as string);

const urlCallback = `${SENGRID_CLIENT}/email-verified`;
const urlCallbackResetPassword = `${SENGRID_CLIENT}/reset-password`;
